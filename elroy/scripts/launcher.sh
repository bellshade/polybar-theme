...
FILE="$HOME/.config/polybar/elroy/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/elroy/scripts/rofi/launcher.rasi
